...
def save_short_data_revise():# no random, not for dis, is for gen Model
    ...
    for i in tqdm.tqdm(range(1, 3)):
        ...
        input_ans_data = []
        output_ans_data = []
        input_bass = np.load(r'E:/CodeProject/1.1.Gen/GenPure/GenPure_network/GenerData/data/NLPdata/input_bass_'+ str(i*1000)+ '.npy', allow_pickle=True)
        input_ans = np.load(r'E:/CodeProject/1.1.Gen/GenPure/GenPure_network/GenerData/data/NLPdata/input_ans_'+ str(i*1000)+ '.npy', allow_pickle=True)
        output_ans = np.load(r'E:/CodeProject/1.1.Gen/GenPure/GenPure_network/GenerData/data/NLPdata/output_ans_'+ str(i*1000)+ '.npy', allow_pickle=True)
        ...
        np.save(r'E:/CodeProject/1.1.Gen/GenPure/GenPure_network/GenerData/data/NLPdata/revise/input_bass8_'+str(i), np.array(input_bass_data))
        np.save(r'E:/CodeProject/1.1.Gen/GenPure/GenPure_network/GenerData/data/NLPdata/revise/input_ans8_'+str(i), np.array(input_ans_data))
        np.save(r'E:/CodeProject/1.1.Gen/GenPure/GenPure_network/GenerData/data/NLPdata/revise/output_ans8_'+str(i), np.array(output_ans_data))
    print('save done!')
...
class BassData_6_revise(tDataset):
    def __init__(self, ):
        np.random.seed(2021)
        self.input_bass = np.load('GenerData/data/NLPdata/revise/input_bass8_1.npy', allow_pickle=True)
        self.input_ans = np.load('GenerData/data/NLPdata/revise/input_ans8_1.npy', allow_pickle=True)
        self.output_ans = np.load('GenerData/data/NLPdata/revise/output_ans8_1.npy', allow_pickle=True)
        # print('self.input_bass: ', self.input_bass.shape)
        # print('self.input_bass: ', self.input_bass)
        # print('self.input_bass: ', self.input_bass[0])
        # print('self.input_ans: ', self.input_ans.shape)
        # print('self.input_ans: ', self.input_ans)
        # print('self.output_ans: ', self.output_ans.shape)
        # print('self.output_ans: ', self.output_ans)
        # for i in range(1,12):
        #     print('datainit: ', i)
        #     self.input_bass = np.concatenate((self.input_bass, np.load('/home/rg/project/re/0.base/gentest/data/NLPdata/revise/input_bass256_'+str(i)+'.npy', allow_pickle=True)), axis=0)
        #     self.input_ans = np.concatenate((self.input_ans, np.load('/home/rg/project/re/0.base/gentest/data/NLPdata/revise/input_ans256_'+str(i)+'.npy', allow_pickle=True)), axis=0)
        #     self.output_ans = np.concatenate((self.output_ans, np.load('/home/rg/project/re/0.base/gentest/data/NLPdata/revise/output_ans256_'+str(i)+'.npy', allow_pickle=True)), axis=0)
    ...
    def __getitem__(self, index):
        # print('index: ', index)
        # print('self.input_bass[index]: ', self.input_bass[index].shape)
        # print('self.input_ans[index]: ', self.input_ans[index].shape)
        # print('self.output_ans[index]: ', self.output_ans[index].shape)
        # print('len(self.output_ans[index]: ', len(self.output_ans[index]))
        return  self.input_bass[index], self.input_ans[index], self.output_ans[index], len(self.output_ans[index])
